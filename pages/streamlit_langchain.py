...
LANGSERVE_ENDPOINT = "https://mentally-thankful-dinosaur.ngrok-free.app/llm/"
...
st.set_page_config(page_title="Bit-Duck에게 물어봐", page_icon="💬")
st.title("비트코인 & 블록체인 챗봇")

st.sidebar.page_link("app.py", label="메인으로 돌아가기")
